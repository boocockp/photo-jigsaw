...
function MainPage(props) {
    ...
    return React.createElement(Page, {path: props.path},
        ...
        React.createElement(Calculation, {path: pathWith('GameOver'), show: true}),
        React.createElement(Timer, {path: pathWith('GameTimer'), label: 'Time', show: true}),
        ...
        React.createElement(Layout, {path: pathWith('StatusLine'), horizontal: true, wrap: false},
            React.createElement(TextElement, {path: pathWith('MovesTaken'), styles: {}}, Moves + ' moves'),
            React.createElement(TextElement, {path: pathWith('TimeLeft'), styles: {}}, Ceiling(TimeLimit - GameTimer.value) + ' seconds remaining'),
    ),
