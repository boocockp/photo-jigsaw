...
function MainPage(props) {
    ...
    const {Range, Count, Eq, Or, Log, ItemAt, If, Shuffle, Not, Ceiling, IsNull, Floor} = Elemento.globalFunctions
    ...
    return React.createElement(Page, {path: props.path},
        ...
        React.createElement(TextElement, {path: pathWith('Instructions'), show: Not(GameTimer.isRunning)}, `The squares will be scrambled when you start.  
...
export default function PhotoJigsaw(props) {
    const pathWith = name => 'PhotoJigsaw' + '.' + name
    ...
    return React.createElement(App, {path: 'PhotoJigsaw', },)
}
